...
export const metadata: Metadata = generatePageMetadata("About Us - Joint Heirs Assembly");
		...
		<div className="about-page">
			...
			<div className="section-two container">
				...
				<article>
					...
					In dictum tincidunt egestas. Quisque egestas enim elit, in commodo sem pretium eu. Nullam
					vestibulum finibus ligula eget feugiat. Phasellus sit amet mi tristique, imperdiet ex eu,
					commodo neque. Phasellus ex felis, laoreet vitae ex ullamcorper.
				</article>
			</div>
				...
				<div className="section-three-inner container">
					...
					<div className="section-three-inner_right">
						...
						<article>
							...
							elit, in commodo sem pretium eu. Aliquam fringilla, turpis et tempor molestie, urna
							nunc commodo ex, et finibus diam magna a metus. Proin ut tempus odio.
						</article>
					</div>
				</div>
			</div>
				...
				<div className="section-six-images">
					<div className="image">
						...
						<div className="image-description">
							...
							<p>
								Congratulations! You have decided to dedicate your life to following Jesus. You may
								be wondering what’s next ant to help! Join us as we guide you toward the next steps
